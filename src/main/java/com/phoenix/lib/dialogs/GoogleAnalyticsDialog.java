...
public class GoogleAnalyticsDialog {
    ...
    private static final String PREF_NAME = "GoogleAnalyticsDialogPrefs";
    private static final String KEY_INSTALL_DATE = "phoenix_install_date";
    private static final String KEY_LAUNCH_TIMES = "phoenix_launch_times";
    private static final String KEY_OPT_OUT = "phoenix_google_analytics_opt_out";
    ...
    public static void showRateDialog(final Context context) {
        ...
        builder.setTitle(R.string.phoenix_rate_app_dialog_title);
        builder.setMessage(R.string.phoenix_rate_app_dialog_message);
        builder.setPositiveButton(R.string.phoenix_google_analytics_dialog_ok, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                setOptOut(context, true);
            }
        });
        builder.setNeutralButton(R.string.phoenix_google_analytics_dialog_cancel, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                clearSharedPreferences(context);
            }
        });
        builder.setNegativeButton(R.string.phoenix_google_analytics_dialog_no, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                setOptOut(context, true);
            }
