...
public class RateThisAppDialog {
    ...
    private static final String PREF_NAME = "RateThisAppDialogPrefs";
    private static final String KEY_INSTALL_DATE = "phoenix_rate_app_install_date";
    private static final String KEY_LAUNCH_TIMES = "phoenix_rate_app_launch_times";
    private static final String KEY_OPT_OUT = "phoenix_rate_app_opt_out";
    ...
    public static void showRateDialog(final Context context) {
        ...
        builder.setPositiveButton(R.string.phoenix_rate_app_dialog_ok, new OnClickListener() {
            @Override
        ...
        builder.setNeutralButton(R.string.phoenix_rate_app_dialog_cancel, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                clearSharedPreferences(context);
            }
        });
        builder.setNegativeButton(R.string.phoenix_rate_app_dialog_no, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                setOptOut(context, true);
            }
